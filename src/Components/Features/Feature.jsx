...
const Feature = ({ featureHeading, featureContent, featureIcon, alignMent }) => {
    ...
    return (
        <div className={`min-h-[160px] md:min-h-[200px] flex flex-row-reverse lg:flex-${flexDirection} gap-4 items-center justify-around bg-primary text-secondary rounded-lg p-4`}>
